...
CREATE TABLE IF NOT EXISTS web_cargo.order (
                                               ...
                                               unit VARCHAR(255),
                                               product VARCHAR(255),
                                               types_legal_registry VARCHAR(255),
...
-- (id, local_date, quantity, unit, product, types_legal_registry, counterparty, unloading_addresses, map_location, phone_number_consignee, full_name, "cost", descriptions)
-- VALUES

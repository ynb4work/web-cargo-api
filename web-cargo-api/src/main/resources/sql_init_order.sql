...
CREATE TABLE IF NOT EXISTS web_cargo.order (
    ...
    unit VARCHAR(255),
    product VARCHAR(255),
    "types-legal-registry" VARCHAR(255),
...
-- (id, localdate, quantity, unit, product, "types-legal-registry", counterparty, "unloading-addresses", "map-location", "phone-number-consignee", "full-name", "cost", descriptions)
-- VALUES
...
-- ('223e4567-e89b-12d3-a456-426614174001', '2023-11-25', 15.0, 'PCS', 'STONES', 'PP', 'Some Company', 'Маршала 10', '51.123456, 36.654321', '+380991111111', 'Иванов И.И.', 1500.0, 'отгрузить щебень'),
